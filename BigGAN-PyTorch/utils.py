...
def prepare_parser():
  ...
  ### new ###
  parser.add_argument(
    '--loss', type=str, default='gan',
    help='Loss type (gan, dagan, dagan_md, ssgan, ssganms, ssgan_la, ssgan_la_plus)')
  parser.add_argument(
    '--all_T', action='store_true', default=False,
    help='Using all transformations for each data? (default: %(default)s)')
  parser.add_argument(
    '--multi_hinge', action='store_true', default=False,
    help='Using multi-class hinge loss? (default: %(default)s)')
  parser.add_argument(
    '--ss_d', type=float, default=1.0,
    help='Weight of the self-supervised task of the discriminator')
  parser.add_argument(
    '--ss_g', type=float, default=1.0,
    help='Weight of the self-supervised task of the generator') 
...
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder, 
             ...
             'C10': dset.CIFAR10, 'C100': dset.CIFAR100, 'S10': dset.STL10,
             'TINY': dset.ImageFolder, 'TINY_val': dset.ImageFolder,
             'TINY_hdf5': dset.ILSVRC_HDF5, 'TINY_val_hdf5': dset.ILSVRC_HDF5}
imsize_dict = {'I32': 32, 'I32_hdf5': 32,
               'I64': 64, 'I64_hdf5': 64,
               'I128': 128, 'I128_hdf5': 128,
               'I256': 256, 'I256_hdf5': 256,
               'C10': 32, 'C100': 32, 'S10': 48,
               'TINY': 64, 'TINY_val': 64, 
               'TINY_hdf5': 64, 'TINY_val_hdf5': 64}
root_dict = {'I32': 'ImageNet', 'I32_hdf5': 'ILSVRC32.hdf5',
             'I64': 'ImageNet', 'I64_hdf5': 'ILSVRC64.hdf5',
             'I128': 'ImageNet', 'I128_hdf5': 'ILSVRC128.hdf5',
             'I256': 'ImageNet', 'I256_hdf5': 'ILSVRC256.hdf5',
             'C10': 'cifar', 'C100': 'cifar', 'S10': 'stl',
             'TINY': 'tiny_imagenet/train', 'TINY_val': 'tiny_imagenet/val',
             'TINY_hdf5': 'tiny.hdf5', 'TINY_val_hdf5': 'tiny_val.hdf5'}
nclass_dict = {'I32': 1000, 'I32_hdf5': 1000,
               'I64': 1000, 'I64_hdf5': 1000,
               'I128': 1000, 'I128_hdf5': 1000,
               'I256': 1000, 'I256_hdf5': 1000,
               'C10': 10, 'C100': 100, 'S10': 10,
               'TINY': 200, 'TINY_val': 200,
               'TINY_hdf5': 200, 'TINY_val_hdf5': 200}
...
classes_per_sheet_dict = {'I32': 50, 'I32_hdf5': 50,
                          ...
                          'C10': 10, 'C100': 100, 'S10': 10,
                          'TINY': 100, 'TINY_val': 100,
                          'TINY_hdf5': 100, 'TINY_val_hdf5': 100}
...
def get_data_loaders(dataset, data_root=None, augment=False, batch_size=64, 
  ...
  dataset_kwargs = {'index_filename': '%s_imgs.npz' % dataset, 'train': kwargs.get('split') != 'test'}
